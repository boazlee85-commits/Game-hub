...
const SidebarProvider = React.forwardRef(({
  ...
  const contextValue = React.useMemo(
    () => ({
      ...
      open,
      setOpen,
      isMobile: false, // We'll add mobile detection later
      openMobile: false,
      setOpenMobile: () => {},
      toggleSidebar,
    }),
...
const SidebarRail = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 translate-x-1 cursor-col-resize transition-colors ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:-left-4 group-data-[side=right]:cursor-col-resize group-data-[side=right]:rotate-180 sm:flex",
